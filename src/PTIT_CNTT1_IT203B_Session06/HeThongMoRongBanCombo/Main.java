...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Bắt đầu bán vé combo...");
        t1.start();
        t2.start();
//        supthread.start();
...
//        supthread.join();
        ...
        System.out.println("======================================");
        System.out.println("Quầy 1 bán được: " + counter1.getSoldCount() + " combo");
        System.out.println("Quầy 2 bán được: " + counter2.getSoldCount() + " combo");
        System.out.println("Tổng số vé đã bán được: " + (counter1.getSoldCount() + counter1.getSoldCount()) + " combo");
